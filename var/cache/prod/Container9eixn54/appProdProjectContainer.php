...
class appProdProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('9YGBmeM+eT', 0, ($this->targetDirs[0].'/pools'));
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'modules_translation_paths': $value = [
                ...
                55 => ($this->targetDirs[3].'/modules/pm_advancedtopmenu/translations'),
                56 => ($this->targetDirs[3].'/modules/ps_newproducts/translations'),
                57 => ($this->targetDirs[3].'/modules/brlcustomblocks/translations'),
                58 => ($this->targetDirs[3].'/modules/hhproductcomments/translations'),
            ]; break;
