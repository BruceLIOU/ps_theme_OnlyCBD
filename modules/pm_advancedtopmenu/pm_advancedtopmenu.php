...
class PM_AdvancedTopMenu extends AdvancedTopMenuWidgetProxy
{
    ...
    protected $rebuildable_type = array(
        3,
        4,
        5,
        10,
    ...
    protected $allowFileExtension = array(
        'gif',
        'jpg',
        'jpeg',
        'png',
    ...
    public function __construct()
    {
        ...
        if ($this->onBackOffice()) {
            ...
            $this->_fieldsOptions = array(
                ...
                'ATM_RESP_CONT_CLASSES' => array(
                    'title' => $this->l('Menu (#adtm_menu)'),
                    'type' => 'text',
                    'default' => '',
                    'advanced' => true,
                ),
                'ATM_MENU_HAMBURGER_SELECTORS' => array(
                ...
                'ATM_RESPONSIVE_THRESHOLD' => array(
                ...
                'ATM_RESP_TOGGLE_FONT_SIZE' => array(
                ...
                'ATM_RESP_TOGGLE_BG_COLOR_OP' => array(
                ...
                'ATM_RESP_TOGGLE_BG_COLOR_CL' => array(
                ...
                'ATM_RESP_TOGGLE_COLOR_OP' => array(
                ...
                'ATM_RESP_TOGGLE_COLOR_CL' => array(
                ...
                'ATMR_MENU_FONT_TRANSFORM' => array(
                ...
                'ATMR_SUBMENU_BORDERCOLOR' => array(
                    'title' => $this->l('Border color'),
                    'desc' => '',
                    'type' => 'color',
                    'default' => '#e5e5e5',
                ...
                'ATM_RESP_SUBMENU_ICON_OP' => array(
                ...
                'ATM_RESP_SUBMENU_ICON_CL' => array(
                ...
                'ATMR_COLUMNWRAP_BORDERCOLOR' => array(
                    'title' => $this->l('Border color'),
                    'desc' => '',
                    'type' => 'color',
                    'default' => '#e5e5e5',
                ...
                'ATMR_COLUMNWRAP_BORDERSIZE' => array(
                    'title' => $this->l('Border width (px)'),
                    'desc' => '',
                    'type' => '4size',
                    'default' => '0 0 1px 0',
                ...
                'ATMR_COLUMNTITLE_PADDING' => array(
                    'title' => $this->l('Inner spaces - padding (px)'),
                    'desc' => '',
                    'type' => '4size',
                    'default' => '0 0 0 0',
                ...
                'ATM_RESP_COLUMN_FONT_SIZE' => array(
                    'title' => $this->l('Text size (px)'),
                    'desc' => '',
                    'type' => 'select',
                    'default' => 18,
                ...
                'ATMR_COLUMN_FONT_TRANSFORM' => array(
                    'title' => $this->l('Text transformation'),
                    'desc' => '',
                    'type' => 'select',
                    'default' => 'none',
                ...
                'ATMR_COLUMN_ITEM_PADDING' => array(
                    'title' => $this->l('Inner spaces - padding (px)'),
                    'desc' => '',
                    'type' => '4size',
                ...
                'ATM_RESP_COLUMN_ITEM_FONT_SIZE' => array(
                    'title' => $this->l('Text size (px)'),
                    'desc' => '',
                    'type' => 'select',
                    'default' => 16,
                ...
                'ATMR_COLUMN_ITEM_FONT_BOLD' => array(
                    'title' => $this->l('Text in bold'),
                    'desc' => '',
                    'cast' => 'intval',
                    'type' => 'bool',
                ...
                'ATMR_COLUMN_ITEM_FONT_TRANSFORM' => array(
                    'title' => $this->l('Text transformation'),
                    'desc' => '',
                    'type' => 'select',
                    'default' => 'none',
                ...
                'ATMR_COLUMN_ITEM_FONT_FAMILY' => array(
                    'title' => $this->l('Text font'),
                    'desc' => '',
                    'type' => 'select',
                    'default' => 0,
                ...
                'ATM_THEME_COMPATIBILITY_MODE' => array(
                ...
                'ATM_MENU_CONT_PADDING' => array(
                    'title' => $this->l('Inner spaces - padding (px)'),
                    'desc' => '',
                    'type' => '4size',
                    'default' => '0 0 0 0',
                ),
                'ATM_MENU_CONT_MARGIN' => array(
                    'title' => $this->l('Outer spaces - margin (px)'),
                    'desc' => '',
                    'type' => '4size',
                    'default' => '20px 0 0 0',
                ),
                'ATM_MENU_CONT_BORDERCOLOR' => array(
                    'title' => $this->l('Border color'),
                    'desc' => '',
                    'type' => 'color',
                    'default' => '#333333',
                ),
                'ATM_MENU_CONT_BORDERSIZE' => array(
                    'title' => $this->l('Border width (px)'),
                    'desc' => '',
                    'type' => '4size',
                    'default' => '5px 0 0 0',
                ),
                'ATM_MENU_CONT_POSITION' => array(
                ...
                'ATM_MENU_CONT_POSITION_TRBL' => array(
                ...
                'ATM_MENU_BOX_SHADOW' => array(
                    'title' => $this->l('Drop shadow'),
                    'desc' => '',
                    'type' => 'shadow',
                    'default' => '0px 5px 13px 0px',
                ),
                'ATM_MENU_BOX_SHADOWCOLOR' => array(
                    'title' => $this->l('Drop shadow color'),
                    'desc' => '',
                    'type' => 'color',
                    'default' => '#000000',
                ),
                'ATM_MENU_BOX_SHADOWOPACITY' => array(
                ...
                'ATM_MENU_FONT_UNDERLINEOV' => array(
                ...
                'ATM_SUBMENU_BOX_SHADOW' => array(
                    'title' => $this->l('Drop shadow'),
                    'desc' => '',
                    'type' => 'shadow',
                    'default' => '0px 5px 13px 0px',
                ),
                'ATM_SUBMENU_BOX_SHADOWCOLOR' => array(
                    'title' => $this->l('Drop shadow color'),
                    'desc' => '',
                    'type' => 'color',
                    'default' => '#000000',
                ),
                'ATM_SUBMENU_BOX_SHADOWOPACITY' => array(
                    'title' => $this->l('Drop shadow opacity'),
                    'desc' => '',
                    'type' => 'slider',
                    'default' => 20,
                ...
                'ATM_COLUMNTITLE_PADDING' => array(
                    'title' => $this->l('Inner spaces - padding (px)'),
                    'desc' => '',
                    'type' => '4size',
                    'default' => '0 0 0 0',
                ),
                'ATM_COLUMNTITLE_MARGIN' => array(
                    'title' => $this->l('Outer spaces - margin (px)'),
                    'desc' => '',
                    'type' => '4size',
                    'default' => '0 10px 0 0',
                ...
                'ATM_COLUMN_FONT_UNDERLINE' => array(
                    'title' => $this->l('Underline text'),
                    'desc' => '',
                    'cast' => 'intval',
                    'type' => 'bool',
                ...
                'ATM_COLUMN_FONT_UNDERLINEOV' => array(
                    'title' => $this->l('Underline text (on mouse over)'),
                    'desc' => '',
                    'cast' => 'intval',
                    'type' => 'bool',
                ...
                'ATM_COLUMN_FONT_TRANSFORM' => array(
                    'title' => $this->l('Text transformation'),
                    'desc' => '',
                    'type' => 'select',
                    'default' => 'none',
                ...
                'ATM_COLUMN_ITEM_FONT_BOLD' => array(
                    'title' => $this->l('Text in bold'),
                    'desc' => '',
                    'cast' => 'intval',
                    'type' => 'bool',
                ...
                'ATM_COLUMN_ITEM_FONT_UNDERLINE' => array(
                    'title' => $this->l('Underline text'),
                    'desc' => '',
                    'cast' => 'intval',
                    'type' => 'bool',
                ...
                'ATM_COLUMN_ITEM_FONT_UNDERLINEOV' => array(
                    'title' => $this->l('Underline text (on mouse over)'),
                    'desc' => '',
                    'cast' => 'intval',
                    'type' => 'bool',
                ...
                'ATM_COLUMN_ITEM_FONT_TRANSFORM' => array(
                    'title' => $this->l('Text transformation'),
                    'desc' => '',
                    'type' => 'select',
                    'default' => 'none',
    ...
    public function getContent()
    {
        ...
        if (!$moduleIsUpToDate) {
            return $this->fetchTemplate('module/new_version.tpl', array('css_js_assets' => $this->includeAdminCssJs()));
        }
        ...
        if (!empty($permissionsErrors)) {
            ...
            $this->context->controller->warnings[] = implode('<br />', $permissionsErrors);
        }
    ...
    protected function includeAdminCssJs()
    {
        ...
        $this->context->controller->addJqueryUI(array('ui.draggable', 'ui.droppable', 'ui.sortable', 'ui.widget', 'ui.tabs'), '../../../../modules/' . $this->name . '/views/css/jquery-ui-theme');
        return $return . '
        <script type="text/javascript">
            ...
            var pmAtmTranslatedIconSearchLabel = "' . $this->l('Search an icon') . '";
        </script>';
    }
    ...
    public function getLinkOutputValue($row, $type, $withExtra = true, $haveSub = false, $first_level = false)
    {
        ...
        if ($icone) {
            if (in_array($row['image_type'], array('i-fa', 'i-mi'))) {
                ...
                $return .= '<img src="' . $icone . '" alt="' . $image_legend . '" title="' . $image_legend . '" ' . ((int)$iconWidth > 0 ? 'width="' . (int)$iconWidth . '" ' : '') . ((int)$iconHeight > 0 ? 'height="' . (int)$iconHeight . '" ' : '') . 'class="adtm_menu_icon img-responsive img-fluid" />';
            }
        }
        $return .= nl2br($name);
        if ($type == 'menu') {
        ...
        if ($row['type'] == 1) {
            if ($withExtra && trim($row['have_icon'])) {
                if (in_array($row['image_type'], array('i-fa', 'i-mi'))) {
                    ...
                    $return .= '<img src="' . $this->_path . $type . '_icons/' . $row['id_' . $type] . '-' . $this->_iso_lang . '.' . ($row['image_type'] ?: 'jpg') . '" alt="' . htmlentities($row['name'], ENT_COMPAT, 'UTF-8') . '" title="' . htmlentities($row['name'], ENT_COMPAT, 'UTF-8') . '" />';
                }
            }
            if (trim($row['name'])) {
            ...
            case 10:
                ...
                if (count($firstChildCategories)) {
                    ...
                    if (count($categoryCmsPages)) {
                        ...
                        $columnWithNoDepth = false;
                        if (Tools::getValue('id_menu', false)) {
                            $idColumn = AdvancedTopMenuColumnClass::getIdColumnCmsCategoryDepend($AdvancedTopMenuClass->id, $AdvancedTopMenuClass->id_cms_category);
                            if (!$idColumn && !Tools::getValue('rebuild')) {
                                return;
                            }
                            if ($idColumn) {
                        ...
                        $AdvancedTopMenuColumnClass = $this->fetchOrCreateColumnObject($columnWithNoDepth, $AdvancedTopMenuClass, 'id_cms_category', $firstChildCategory, 2);
                        if (!$columnWithNoDepth) {
                            $AdvancedTopMenuColumnWrapClass = $this->createColumnWrap($AdvancedTopMenuClass->id);
                            $AdvancedTopMenuColumnClass->id_wrap = $AdvancedTopMenuColumnWrapClass->id;
                        }
    ...
    protected function fetchOrCreateColumnObject($idColumn, $advancedTopMenuClass, $fieldName, $entity, $columnType = null)
    {
        ...
        $AdvancedTopMenuColumnClass->{$fieldName} = $entity[$fieldName];
                ...
                if (!count($this->context->controller->errors)) {
                    foreach ($languages as $language) {
                        ...
                        if (!isset($_FILES[$fileKey]['tmp_name']) || $_FILES[$fileKey]['tmp_name'] == null) {
                            ...
                            if (!in_array($iconLibraryValue, array('fa', 'mi'))) {
    ...
    protected function postProcess()
    {
        ...
        if (Tools::getIsset('activeMaintenance')) {
            ...
            if (!empty($elementId) && !empty($newGroupId)) {
                Db::getInstance()->update('pm_advancedtopmenu_elements', array('id_column' => $newGroupId), 'id_element =' . (int)$elementId);
            ...
            if (!empty($columnId) && !empty($newGroupId)) {
                Db::getInstance()->update('pm_advancedtopmenu_columns', array('id_wrap' => $newGroupId), 'id_column =' . (int)$columnId);
                $order = Tools::getValue('orderColumn') ? explode(',', Tools::getValue('orderColumn')) : array();
                foreach ($order as $position => $id_column) {
                    if (!trim($id_column)) {
                        continue;
                    }
            ...
            if ($ObjAdvancedTopMenuClass->save()) {
                if (version_compare(_PS_VERSION_, '1.7.0.0', '>=')) {
                    ...
                    if ($ObjAdvancedTopMenuClass->active) {
                        $return .= '$("#imgActiveMenu' . $ObjAdvancedTopMenuClass->id . '").removeClass("icon-remove").addClass("icon-check");';
                    } else {
                        $return .= '$("#imgActiveMenu' . $ObjAdvancedTopMenuClass->id . '").removeClass("icon-check").addClass("icon-remove");';
                    }
                }
            ...
            if ($ObjAdvancedTopMenuColumnWrapClass->save()) {
                if (version_compare(_PS_VERSION_, '1.7.0.0', '>=')) {
                    ...
                    if ($ObjAdvancedTopMenuColumnWrapClass->active) {
                        $return .= '$("#imgActiveColumnWrap' . $ObjAdvancedTopMenuColumnWrapClass->id . '").removeClass("icon-remove").addClass("icon-check");';
                    } else {
                        $return .= '$("#imgActiveColumnWrap' . $ObjAdvancedTopMenuColumnWrapClass->id . '").removeClass("icon-check").addClass("icon-remove");';
                    }
                }
            ...
            if ($ObjAdvancedTopMenuColumnClass->save()) {
                if (version_compare(_PS_VERSION_, '1.7.0.0', '>=')) {
                    ...
                    if ($ObjAdvancedTopMenuColumnClass->active) {
                        $return .= '$("#imgActiveColumn' . $ObjAdvancedTopMenuColumnClass->id . '").removeClass("icon-remove").addClass("icon-check");';
                    } else {
                        $return .= '$("#imgActiveColumn' . $ObjAdvancedTopMenuColumnClass->id . '").removeClass("icon-check").addClass("icon-remove");';
                    }
                }
            ...
            if ($AdvancedTopMenuElementsClass->save()) {
                if (version_compare(_PS_VERSION_, '1.7.0.0', '>=')) {
                    ...
                    if ($AdvancedTopMenuElementsClass->active) {
                        $return .= '$("#imgActiveElement' . $AdvancedTopMenuElementsClass->id . '").removeClass("icon-remove").addClass("icon-check");';
                    } else {
                        $return .= '$("#imgActiveElement' . $AdvancedTopMenuElementsClass->id . '").removeClass("icon-check").addClass("icon-remove");';
                    }
                }
            ...
            if ($ObjAdvancedTopMenuClass->save()) {
                if (version_compare(_PS_VERSION_, '1.7.0.0', '>=')) {
                    ...
                    if ($ObjAdvancedTopMenuClass->active_desktop) {
                        $return .= '$("#imgActiveDesktopMenu' . $ObjAdvancedTopMenuClass->id . '").removeClass("icon-remove").addClass("icon-check");';
                    } else {
                        $return .= '$("#imgActiveDesktopMenu' . $ObjAdvancedTopMenuClass->id . '").removeClass("icon-check").addClass("icon-remove");';
                    }
                }
            ...
            if ($ObjAdvancedTopMenuClass->save()) {
                if (version_compare(_PS_VERSION_, '1.7.0.0', '>=')) {
                    ...
                    if ($ObjAdvancedTopMenuClass->active_mobile) {
                        $return .= '$("#imgActiveMobileMenu' . $ObjAdvancedTopMenuClass->id . '").removeClass("icon-remove").addClass("icon-check");';
                    } else {
                        $return .= '$("#imgActiveMobileMenu' . $ObjAdvancedTopMenuClass->id . '").removeClass("icon-check").addClass("icon-remove");';
                    }
                }
            ...
            if ($ObjAdvancedTopMenuColumnWrapClass->save()) {
                if (version_compare(_PS_VERSION_, '1.7.0.0', '>=')) {
                    ...
                    if ($ObjAdvancedTopMenuColumnWrapClass->active_desktop) {
                        $return .= '$("#imgActiveDesktopColumnWrap' . $ObjAdvancedTopMenuColumnWrapClass->id . '").removeClass("icon-remove").addClass("icon-check");';
                    } else {
                        $return .= '$("#imgActiveDesktopColumnWrap' . $ObjAdvancedTopMenuColumnWrapClass->id . '").removeClass("icon-check").addClass("icon-remove");';
                    }
                }
            ...
            if ($ObjAdvancedTopMenuColumnWrapClass->save()) {
                if (version_compare(_PS_VERSION_, '1.7.0.0', '>=')) {
                    ...
                    if ($ObjAdvancedTopMenuColumnWrapClass->active_mobile) {
                        $return .= '$("#imgActiveMobileColumnWrap' . $ObjAdvancedTopMenuColumnWrapClass->id . '").removeClass("icon-remove").addClass("icon-check");';
                    } else {
                        $return .= '$("#imgActiveMobileColumnWrap' . $ObjAdvancedTopMenuColumnWrapClass->id . '").removeClass("icon-check").addClass("icon-remove");';
                    }
                }
            ...
            if ($ObjAdvancedTopMenuColumnClass->save()) {
                if (version_compare(_PS_VERSION_, '1.7.0.0', '>=')) {
                    ...
                    if ($ObjAdvancedTopMenuColumnClass->active_desktop) {
                        $return .= '$("#imgActiveDesktopColumn' . $ObjAdvancedTopMenuColumnClass->id . '").removeClass("icon-remove").addClass("icon-check");';
                    } else {
                        $return .= '$("#imgActiveDesktopColumn' . $ObjAdvancedTopMenuColumnClass->id . '").removeClass("icon-check").addClass("icon-remove");';
                    }
                }
            ...
            if ($ObjAdvancedTopMenuColumnClass->save()) {
                if (version_compare(_PS_VERSION_, '1.7.0.0', '>=')) {
                    ...
                    if ($ObjAdvancedTopMenuColumnClass->active_mobile) {
                        $return .= '$("#imgActiveMobileColumn' . $ObjAdvancedTopMenuColumnClass->id . '").removeClass("icon-remove").addClass("icon-check");';
                    } else {
                        $return .= '$("#imgActiveMobileColumn' . $ObjAdvancedTopMenuColumnClass->id . '").removeClass("icon-check").addClass("icon-remove");';
                    }
                }
            ...
            if ($AdvancedTopMenuElementsClass->save()) {
                if (version_compare(_PS_VERSION_, '1.7.0.0', '>=')) {
                    ...
                    if ($AdvancedTopMenuElementsClass->active_desktop) {
                        $return .= '$("#imgActiveDesktopElement' . $AdvancedTopMenuElementsClass->id . '").removeClass("icon-remove").addClass("icon-check");';
                    } else {
                        $return .= '$("#imgActiveDesktopElement' . $AdvancedTopMenuElementsClass->id . '").removeClass("icon-check").addClass("icon-remove");';
                    }
                }
            ...
            if ($AdvancedTopMenuElementsClass->save()) {
                if (version_compare(_PS_VERSION_, '1.7.0.0', '>=')) {
                    ...
                    if ($AdvancedTopMenuElementsClass->active_mobile) {
                        $return .= '$("#imgActiveMobileElement' . $AdvancedTopMenuElementsClass->id . '").removeClass("icon-remove").addClass("icon-check");';
                    } else {
                        $return .= '$("#imgActiveMobileElement' . $AdvancedTopMenuElementsClass->id . '").removeClass("icon-check").addClass("icon-remove");';
                    }
                }
    ...
    protected function generateGlobalCss($id_shop = false)
    {
        ...
        if ((int)$configGlobalCss['ATM_MENU_CENTER_TABS'] == 1) {
            ...
            $css[] = '}';
        } elseif (in_array((int)$configGlobalCss['ATM_MENU_CENTER_TABS'], array(2, 3))) {
            $css[] = '@media (min-width: ' . ((int)$configResponsiveCss['ATM_RESPONSIVE_THRESHOLD'] + 1) . 'px) {';
    ...
    public function hookDisplayHeader()
    {
        ...
        if ($this->hasAtLeastOneMiIcon($currentLangId)) {
            if (version_compare(_PS_VERSION_, '1.7.0.0', '>=')) {
                $this->context->controller->registerStylesheet('modules-' . $this->name . '-mi', 'https://cdnjs.cloudflare.com/ajax/libs/material-design-iconic-font/2.2.0/css/material-design-iconic-font.min.css', array('server' => 'remote'));
            } else {
                $this->context->controller->addCSS('https://cdnjs.cloudflare.com/ajax/libs/material-design-iconic-font/2.2.0/css/material-design-iconic-font.min.css', 'all');
            }
        }
        if ($this->hasAtLeastOneFaIcon($currentLangId)) {
            if (version_compare(_PS_VERSION_, '1.7.0.0', '>=')) {
                $this->context->controller->registerStylesheet('modules-' . $this->name . '-fa', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.9.0/css/all.min.css', array('server' => 'remote'));
            } else {
                $this->context->controller->addCSS('https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.9.0/css/all.min.css', 'all');
            }
        }
    ...
    public function displaySupport()
    {
        ...
        $vars = array(
            'support_links' => (self::isFilledArray($this->_support_link) ? $this->_support_link : array()),
            'copyright_link' => (self::isFilledArray($this->_copyright_link) ? $this->_copyright_link : false),
            'get_started_image_list' => (isset($this->_getting_started) && self::isFilledArray($this->_getting_started) ? $this->_getting_started : array()),
