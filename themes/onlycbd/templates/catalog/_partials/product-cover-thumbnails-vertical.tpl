 ...
 *}
<div class="images-container-vertical js-images-container row">
  {block name='product_cover'}
    <div class="product-cover col-md-5">
  ...
  {block name='product_images'}
    <div class="js-qv-mask mask col-md-1">
...
<div class="scroll-box-arrows vertical">
